...
- Card images are served from `https://fowsim.s3.amazonaws.com/media/cards/<image>.jpg` (the fowsim
  owner has agreed to the extension using the bucket; base URL lives in `tools/config.py`).
